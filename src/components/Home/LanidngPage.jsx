...
const featuredItalyJobs = {
  ...
  description:
    "Professional Careers in Italy Begin Here, With Accredited Training + Job Support.",
...
const hospitalityPositions = [
  {
    ...
    title: "Hostess",
    description:
      "Welcome guests, manage reservations, and ensure excellent first impressions.",
  },
  {
    icon: "☕",
    title: "Barista",
    description:
      "Prepare and serve premium coffee beverages with exceptional customer.",
  },
  {
    icon: "🍽️",
  ...
  },
  {
    ...
    description:
      "Maintain high standards of cleanliness and comfort in guest rooms.",
  },
  {
    icon: "👔",
  ...
  },
  {
    icon: "🍳",
    title: "Commi III",
    description: "Support kitchen operations and learn from experienced chefs.",
  },
  {
    icon: "🧹",
    title: "Steward",
    description: "Maintain kitchen cleanliness and support culinary team.",
  },
  {
    icon: "🛎️",
    title: "Bellman",
    description: "Assist guests with luggage and provide warm welcomes.",
  },
];
...
const domesticPositions = [
  {
    ...
    description: "Provide childcare services in private households.",
  },
  {
    icon: "🚗",
    title: "Private Driver",
    description: "Provide safe transportation for families.",
  },
  {
    icon: "👨‍🍳",
    title: "Cook/Chef",
    description: "Prepare meals in private household settings.",
  },
  {
    icon: "👵",
    title: "Caregiver",
    description: "Provide care for elderly or special needs individuals.",
  },
  {
    icon: "🏠",
    title: "Domestic Worker",
    description: "Perform various household tasks and maintenance.",
  },
  {
    icon: "🧹",
  ...
  // },
  {
    ...
    description: "Specialized care for senior family members.",
  },
];
...
const activeHospitalityDot = Math.floor(
  hospitalityCurrentIndex / getItemsPerSlide()
);
const activeDomesticDot = Math.floor(domesticCurrentIndex / getItemsPerSlide());
const hospitalityDots = Math.ceil(
  hospitalityPositions.length / getItemsPerSlide()
);
    ...
    <section className="hero">
      <div className="container">
        <div className="hero-content">
          ...
          <p>
            Discover your path to international employment with our diverse job
            offerings
          </p>
        ...
        <div className="hero-image">
          <div className="image-placeholder">
            <div className="floating-card card-1">
              ...
              <button className="btn-apply" onClick={() => handleApplyItaly()}>
                Apply Now
              </button>
            </div>
      ...
      {showBanner && (
        <div className="top-banner">
          <p style={{ color: "black" }}>
            ...
            — Competitive salaries, free accommodation & career growth
            opportunities!
          </p>
        ...
        <div className="job-types-grid">
          <div className="job-type-card">
            ...
            <p>
              ...
              experienced nurses and doctors for exciting healthcare careers in
              Brunei. With competitive salaries, comprehensive benefits, and
              excellent career growth opportunities, this is a golden chance to
              work in one of Asia’s most promising healthcare systems.
            </p>
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    <strong>Doctors</strong> (GP, Medical Officers, Consultants,
                    Specialists, Registrars, etc.) 💰 Salary: PKR 650K – 3.3M /
                    £1,740 – £8,700 (depending on role & specialization)
                  </li>
                </ul>
              </li>
      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p>
              Connecting talent with international opportunities across multiple
        ...
        <div className="footer-bottom">
          <p>
            &copy; 2025 College of International Skill Developments. All rights
            reserved.
          </p>
